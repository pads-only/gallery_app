<header class="bg-gray-900">
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <el-popover-group class="hidden lg:flex lg:gap-x-12">
            <a href="/books/gallery_project/" class="text-sm/6 font-semibold text-white">Home</a>
            <a href="/books/gallery_project/create" class="text-sm/6 font-semibold text-white">Upload Image</a>
        </el-popover-group>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-white/10">
                            <div class="space-y-2 py-6">
                                <a href="/books/gallery_project/" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Home</a>
                                <a href="/books/gallery_project/create" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Upload Image</a>
                            </div>
                            <div class="py-6">
